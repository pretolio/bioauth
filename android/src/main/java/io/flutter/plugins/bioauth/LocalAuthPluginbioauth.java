...
package io.flutter.plugins.bioauth;
...
import io.flutter.plugins.bioauth.AuthenticationHelper.AuthCompletionHandler;
import java.util.ArrayList;
import java.util.concurrent.atomic.AtomicBoolean;

/** LocalAuthPlugin */
public class LocalAuthPluginbioauth implements MethodCallHandler {
  ...
  public static void registerWith(Registrar registrar) {
    final MethodChannel channel =
        new MethodChannel(registrar.messenger(), "plugins.flutter.io/bioauth");
    channel.setMethodCallHandler(new LocalAuthPluginbioauth(registrar));
  }

  private LocalAuthPluginbioauth(Registrar registrar) {
